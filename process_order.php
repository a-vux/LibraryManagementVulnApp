...
$shipping_method = $_POST['shipping'] === 'pickup' ? 'Pickup at Store' : 'Standard Delivery';
$shipping_fee = $shipping_method === 'Pickup at Store' ? 0.00 : 10.00;
$payment_method = $_POST['payment'] ?? 'Cash on Delivery (COD)';
