              ...
              <div class="user-items d-flex">
                <ul class="d-flex justify-content-end list-unstyled mb-0">
                  ...
                  <?php if (isset($_SESSION['user'])): ?>
                    <li class="pe-3">
                      <a href="index.php?page=profile.php&id=<?= urlencode($_SESSION['user']['id']) ?>">Hello, <?php echo htmlspecialchars($_SESSION['user']['username']); ?>!</a>
                    </li>
                    <li class="pe-3">
                  ...
                  <li class="cart-dropdown dropdown">
                    <a href="cart.php" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                      ...
                      <?php if (count($cart_items) > 0): ?>
                        <span class="fs-6 fw-light">(<?= count($cart_items) ?>)</span>
                      <?php endif; ?>
                    </a>
                    <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3" style="max-height: 500px; overflow-y: auto;">
                      <?php if (count($cart_items) > 0): ?>
...
function updateHeaderCartCount() {
    fetch('get_cart_count.php')
        .then(res => res.json())
        .then(data => {
            const span = document.querySelector('.cart-dropdown .fs-6');
